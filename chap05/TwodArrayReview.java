...
public class TwodArrayReview {
	...
	public static void main(String[] args) {
		int arr1[][] = { { 1, 2, 3 }, { 4, 5 } };
		// 2행 : 0행은 크기가 3인 배열, 1행은 배열의 크기가 2인 배열
		// 각 행의 열의 ㅋ그리르 가변할 수 있음.
		int arr2[][] = new int[3][4]; // 위에꺼랑 같은 선언
		...
		// 값 출력
		for(int i=0;i<arr4.length;i++) {	//행의 수
			for(int j=0;j<arr4[i].length;j++) {	// j의
